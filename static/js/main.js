...
function set_players(item) {
    ...
    if (count === "3") {
       $(".extend").html(`<label class="ml-3">Player 3: &nbsp<input class="form-control-sm" type="text" name="username" placeholder=" Yoni" value="logan" minlength="4" maxlength="7" required/></label><br>`)
    } else if (count === "4") {
        $(".extend").html(`<label class="ml-3">Player 3: &nbsp<input class="form-control-sm" type="text" name="username" placeholder=" Yoni" value="logan"  minlength="4" maxlength="7" required/></label><br><label class="ml-4">Player 4: &nbsp<input class="form-control-sm" type="text" name="username" placeholder=" Damian" value="joe"  minlength="4" maxlength="7" required/></label><br>`)
    } else {
        $(".extend").html(``)
    }
}
